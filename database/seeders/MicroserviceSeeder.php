...
class MicroserviceSeeder extends Seeder
{
    ...
    public function run()
    {
        $microservices = [
            ...
            ['name' => 'ml_withdraw', 'hostname' => 'http://ml_withdraw', 'port' => 80, 'consumer_logs' => 0, 'consumer_error_logs' => 0, 'status' => 0],
            ['name' => 'ml_transaction', 'hostname' => 'http://ml_transaction', 'port' => 80, 'consumer_logs' => 0, 'consumer_error_logs' => 0, 'status' => 0],
